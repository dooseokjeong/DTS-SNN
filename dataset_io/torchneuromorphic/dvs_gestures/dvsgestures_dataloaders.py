...
# A small modification was made to address some errors in DVS128-Gesture data loading                        #
##############################################################################################################
...
class DVSGestureDataset(NeuromorphicDataset):
    directory = 'dataset/DVS128-Gesture/'
...
def create_dataloader(
        root = './dataset/DVS128-Gesture/dvs128-gestures.hdf5',
        batch_size = 72 ,
