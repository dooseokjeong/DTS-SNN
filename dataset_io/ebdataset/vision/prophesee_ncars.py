###########################################################################################
# This file is adapted from python-ebdataset (https://github.com/tihbe/python-ebdataset). #
###########################################################################################
...
class PropheseeNCars(data.Dataset):
    ...
    def __init__(self, path: str, is_train: bool = True, transforms=None):
        ...
        self._labels[self._labels == 'cars'] = 1
        self._labels[self._labels == 'background'] = 0
        self._labels = self._labels.astype('int')
